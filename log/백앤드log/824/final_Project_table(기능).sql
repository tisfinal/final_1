...
--호텔등록 -----------------------------------------
insert INTO hotel VALUES(hotel_seq.nextval,'107-81-33333','test_hotel','테스트호텔입니다.','경기도 김포시 통진읍 도사리','010-0101-1111','김포','통진읍','2_1_01.png','테스트호텔',150000);
select * from hotel;

--호텔정보 수정
update hotel set hname ='test수정', htitle ='테스트수정중', hotel_address='테스트', phone='010-999-9999', sido = '김포시', gungu = '통진', business_id ='000-0000-1000', description = '수정완료' where hotel_id = 3004;
...
--방등록
insert into room VALUES(room_seq.nextval,'테스트방',150000,'123',2999);
select * from room;
